...
class Solution:
    ...
    def minimumDeviation(self, nums: List[int]) -> int:
        ...
        # print("do3:",nums)
        p = nums.copy()
        minOddIndex = self.getMinOddIndex(nums)
        maxEvenIndex = self.getMaxEvenIndex(nums)
        self.do4(nums,minOddIndex,maxEvenIndex)
        # self.do2(nums)
    ...
    def getMaxOddValue(self,nums) -> None:
        ...
        for a in reversed(nums):
            if a % 2 == 0:
                ...
                break  
        # for a in reversed(nums):
        #     if a >= self.maxOddValue:
        #         print(a)    
    def getMinOddIndex(self,nums) -> Optional[int]:
        oddIndex = None
        i = 0
        while i < len(nums):
            if nums[i] % 2 == 1:
            ...
            i += 1
        return oddIndex
    def getMaxEvenIndex(self,nums) -> Optional[int]:
        evenIndex = None
        i = len(nums) - 1
        while i >= 0:
            if nums[i] % 2 == 0:
    ...
    def remove_all_by_value(self,nums,value) -> int: # return : remove count
        ...
        while value in nums :
            ...
            count += 1
        return count
    def do4(self,nums,oddIndex,evenIndex) -> None :
        isChanged = True
            ...
            if evenIndex != None:
                ...
                if self.minDeviation > deviation:
                    ...
                    for _ in range(count):
                        ...
                        bisect.insort(nums,a)
            if isChanged == True:
                oddIndex = self.getMinOddIndex(nums)
                evenIndex = self.getMaxEvenIndex(nums)
